        ...
        <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--color-bg)' }}>
            <div className="glass-card w-full max-w-md p-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-[var(--color-text-muted)] mt-2">{t('admin_subtitle')}</p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5">{t('username')}</label>
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5">{t('password')}</label>
